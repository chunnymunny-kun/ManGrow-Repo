...
<body>
    ...
    <main>
        ...
        <div class="events-container">
            ...
            <?php   
                $query = "SELECT event_id, title, description, organization, thumbnail, venue, barangay, area_no, start_date, program_type, participants, created_at  FROM eventstbl WHERE is_approved = 'Approved';";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($items = mysqli_fetch_assoc($result)) {
                        ...
                        if ($items['program_type'] !== 'Announcement') {
                            echo '<button class="attend-btn"><i class="fas fa-calendar-check"></i> Attend</button>
                                  <span class="attendee-count"><i class="fas fa-users"></i> '.$items['participants'].' attending</span>';
                        }
